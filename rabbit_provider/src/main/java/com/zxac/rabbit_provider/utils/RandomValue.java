package com.zxac.rabbit_provider.utils;

import com.zxac.rabbit_provider.model.User;
...
public class RandomValue {
    ...
    public static User getAddress() {
        return User.builder().name(getChineseName()).sex(name_sex).idCard(new IdCardGenerator().generate())
                .road(getRoad()).tel(getTel()).email(getEmail(6, 9)).build();
    }
